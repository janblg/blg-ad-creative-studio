...
>
> **Next action:** **Phase 5 — node board + whole-app dark design system** (React Flow, tabbed workspaces, left chat column, node cards with labeled ports, right-drawer detail, node status). It renders from the persisted batch. THEN Phase 6 review/export, Phase 7 preference memory (`feedback` rows accumulating from every hook selection since Phase 3).
>
